...
cl_alpha = [-1.25,-1.375,-1.53,-1.45,-1.3,-1.05,-0.8,-0.6,-0.4,-0.2,0, ...
    0.2,0.4,0.6,0.8,1.05,1.3,1.45,1.53,1.375,1.25]; % from ref [2]

cl = [-1.2,-1,-0.8,-0.6,-0.4,-0.2,0,0.2,0.4,0.6,0.8,1,1.2];
cd = [0.01285,0.0105,0.0086,0.0073,0.0065,0.006,0.0058,0.006,0.0065,0.0073,0.0086,0.0105,0.01285]; % from ref [1]

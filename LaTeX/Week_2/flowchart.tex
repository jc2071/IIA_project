...
\draw   (65.63,47.62) -- (127.49,47.51) .. controls (135.52,47.5) and (142.06,55.53) .. (142.09,65.46) .. controls (142.12,75.38) and (135.62,83.44) .. (127.59,83.45) -- (65.73,83.56) .. controls (57.7,83.57) and (51.16,75.54) .. (51.13,65.61) .. controls (51.1,55.69) and (57.6,47.63) .. (65.63,47.62) -- cycle ;
...
\draw    (37.27,404.44) -- (10.12,404.43) -- (9,154.2) -- (58.45,153.34) ;
\draw [shift={(60.45,153.3)}, rotate = 539.01] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
%Flowchart: Data [id:dp8186807487841803] 
\draw   (66.99,129.36) -- (139.68,129.36) -- (122.91,190.98) -- (50.21,190.98) -- cycle ;
%Straight Lines [id:da3682494150831873] 
\draw    (96.6,82.86) -- (97.23,125.4) ;
\draw [shift={(97.26,127.4)}, rotate = 269.15] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
\end{minipage}};
% Text Node
\draw (84.09,59.01) node [anchor=north west][inner sep=0.75pt]  [font=\small,rotate=-358.05,xscale=0.85,yscale=0.85] [align=left] {{\footnotesize start}};
% Text Node
\draw (59.17,257.54) node [anchor=north west][inner sep=0.75pt]  [font=\small,rotate=-359.86,xscale=0.85,yscale=0.85] [align=left] {\begin{minipage}[lt]{66.671875pt}\setlength\topsep{0pt}
\begin{center}
{\small Natural transition }\\{\footnotesize check}
\end{center}

\end{minipage}};
% Text Node
\draw (59.55,377.21) node [anchor=north west][inner sep=0.75pt]  [rotate=-359.86,xscale=0.85,yscale=0.85] [align=left] {\begin{minipage}[lt]{64.419375pt}\setlength\topsep{0pt}
\begin{center}
...
% Text Node
\draw (60.3,148.52) node [anchor=north west][inner sep=0.75pt]  [rotate=-359.86,xscale=0.85,yscale=0.85] [align=left] {\begin{minipage}[lt]{48.98125pt}\setlength\topsep{0pt}
\begin{center}
{\footnotesize Laminar flow}
\end{center}

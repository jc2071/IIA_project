...
names = ["Stagnation point","natural transition","laminar separation",...
    "turbulent reattachment","turbulent separation","natural transition",...
        ...
        switch varargin{1}.SelectionType
            ...
            case 'normal'
                ...
                if V2>min(1e-4,mindist2)
                    ...
                    if V2<1e-4
                        ...
                        plot(xs,ys,'k', ...
                            [1;x],[0;y],'.k', ...
                            x(I),y(I),'xk','markersize',13,'HandleVisibility','off')
            ...
            case 'alt'
                ...
                if V2<min([1e-4,mindist2])
                    ...
                    try delete(t);end;
                    plot(xs,ys,'k', ...
                        [1;x],[0;y],'.k','markersize',13,'HandleVisibility','off')
                    Replot(); % Our additions
                    axis equal
                    axis([0 1 -.2 .2])
                    drawnow
            ...
            case 'normal'
                ...
                if V2>min(1e-6,mindist2)
                    ...
                    if V2<1e-6
                        ...
                        plot(xs,ys,'k', ...
                            [1;x],[0;y],'.k', ...
                            x(I),y(I),'xk','markersize',13,'HandleVisibility','off');last_index
                        Replot(); % Our additions
                        axis equal
                        axis([0 1 -.2 .2])
                        %drawnow
    ...
    for im = 1:9
        if iss(im) ~= 0
           plot(x_plot(iss(im)), y_plot(iss(im)), imarkers(im),...
               'Markersize', 10, 'markerfacecolor', 'm','DisplayName', names(im));
        end
    end
    legend(legendUnq(),'FontSize',14);
